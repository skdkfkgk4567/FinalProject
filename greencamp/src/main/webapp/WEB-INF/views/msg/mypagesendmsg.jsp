...
function show()
{
   ...
   params = 'rcver_id='+rcver_id+'&cn='+cn+'&sender_id='+sender_id;
   sendXHR('myapgewritesendmsg.pi',params,showResult,'GET');
}
...
function gopage(){
	location.href="mypagesendmsg.pi";
    ...
    <div class="writemsgpaper">
      ...
      <form id="sendmsgForm" name="sendmsgForm" action="writesendmsg.pi">
        ...
        <div class="row">
         ...
         <input type="hidden" name="sender_id" id="sender_id"  value="${sessionScope.user_id}">
        </div>
        <div class="row">
