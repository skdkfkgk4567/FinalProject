				...
				<h1 class="h1-title">공지사항 게시글</h1>
					<input type="checkbox" id="btn_write">
								...
								<div class="container" role="main">
									<h2>공지사항 등록</h2>
									<br>
									<form name="writeNoticePost" id="form" method="post" action="writeNoticePost.pi">
										<div class="mb-3">
						...
						<tbody>
							...
							<c:forEach var="bdto" items="${list}">
								<tr>
									...
									<td><a href="deleteNoticePost.pi?bbs_no=${bdto.bbs_no}&ctgry=${bdto.ctgry}">삭제</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
