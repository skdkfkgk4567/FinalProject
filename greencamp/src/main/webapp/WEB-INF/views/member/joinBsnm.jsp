	...
	<div class="joincontainer">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form class="validation-form" name="joinBsnmComplete" action="joinBsnmComplete.pi">
					<div class="mb-3">
						<label for="name">이름</label> <input type="text"
							class="form-control" id="nm" name="nm" placeholder="" value="" required>
					...
					<div class="mb-3">
						<label for="email">이메일</label> <input type="email"
							class="form-control" id="email" name="email" placeholder="example@example.com"
							required>
					...
					<div class="mb-3">
						<label for="telno">전화번호</label> <input type="tel"
							class="form-control" id="telno" name="telno" placeholder="예)010-0000-0000"
							required pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" maxlength="13">
						<div class="invalid-feedback">전화번호를 입력해주세요.</div>
					</div>
					<div class="mb-3">
						<label for="bizrno">사업자번호</label>
						<input type="text" class="form-control" name="bizrno" placeholder="예)000-00-00000" required pattern="[0-9]{3}-[0-9]{2}-[0-9]{5}" maxlength="13">
					...
					<input type="hidden" value="0" name="account_no">

					<button class="joinbtn btn-primary btn-lg btn-block" type="submit">회원가입</button>
				</form>
			</div>
		</div>
